...
type ExampleFilmHeroSpotlightProps = {
  className?: string;
  photoSrc: string;
  photoAlt: string;
  label: string;
...
export function ExampleFilmHeroSpotlight({
  className = "",
  photoSrc,
  photoAlt,
  label,
    ...
    >
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-6">
        <div className="mx-auto shrink-0 sm:mx-0">
          <div className="relative h-32 w-32 overflow-hidden rounded-full border-2 border-gold/45 shadow-glow-gold-subtle ring-4 ring-gold/10 sm:h-36 sm:w-36">
            <Image
              src={photoSrc}
              alt={photoAlt}
              fill

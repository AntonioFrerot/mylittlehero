...
export function ExampleFilmQualityHint() {
  ...
  return (
    <div
      ...
      className="quality-hint pointer-events-none absolute right-[calc(0.5rem+5px)] top-[22%] z-10 w-[min(9.25rem,84vw)] touch-none sm:right-[calc(1.5rem+4px)] sm:top-[9%] sm:w-48"
    >
      <div className="quality-hint__stack pointer-events-none">
        <div className="quality-hint__anim pointer-events-none">
          <div className={`${SURFACE_3D_CALLOUT} quality-hint__card pointer-events-none backdrop-blur-md`}>
            <span

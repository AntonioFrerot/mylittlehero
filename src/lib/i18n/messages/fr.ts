export const fr = {
  ...
  admin: {
    ...
    navClients: "Clients",
    navClientsHint: "Comptes, tickets, notifications et support",
    ...
    categoryClientsLead:
      "Consultez les comptes clients, leurs personnages et films, accordez des tickets et gérez le support.",

export const en = {
  ...
  admin: {
    ...
    analyticsLead:
      "Real production visitors only: excludes admin, local traffic, each visitor counted once.",
    ...
    analyticsChartTitle: "Unique visitors over time",
    analyticsChartHint:
      "Bar height = unique visitors. Each person is counted once per interval.",
    ...
    analyticsNoGeo: "No geographic data (available in production on Vercel).",

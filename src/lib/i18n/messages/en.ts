export const en = {
  meta: {
    ...
    calendarDescription:
      "Schedule your films in advance and plan several creations at a glance.",
  },
  nav: {
  ...
  admin: {
    ...
    navGroupAccounts: "Accounts & tools",
    navFilms: "Films",
    navFilmsHint: "Delivery and production tracking",
    navClients: "Clients",
    navClientsHint: "Directory of registered accounts",
    navManage: "Management",
    navManageHint: "Tickets, notifications, support and tools",
    navStats: "Statistics",
    navStatsHint: "Visitors and site traffic",
    manageSubNavLabel: "Management sub-sections",
    manageTabCredits: "Tickets & tokens",
    manageTabNotifications: "Notifications",
    manageTabSupport: "Support",
    manageTabTools: "Test tools",
    overview: {
      awaitingFilms: "Films awaiting",
      clients: "Registered clients",
    },
    creditsSelectedEmail: "Selected client: {email}",
    categoryFilmsTitle: "Film production",
    categoryFilmsLead:
      "Validated films awaiting delivery and completed film history.",
    categoryClientsTitle: "Client directory",
    categoryClientsLead:
      "Browse accounts, characters, films and subscriptions. Click an email to manage credits.",
    categoryManageTitle: "Account management",
    categoryManageLead:
      "Grant credits, send notifications, review support or simulate a client profile.",
    ...
    filmsTabsLabel: "Film categories",
    filmsTabUrgent: "Awaiting (24 h)",
    filmsTabScheduled: "Scheduled",
    filmsTabCompleted: "Completed",
    ...
    awaitingUrgentTitle: "24 h delivery priority",
    awaitingUrgentLead:
      "Films without a future scheduled date — 24 h deadline from creation. Most urgent first.",
    awaitingUrgentEmpty: "No urgent films at the moment.",
    awaitingScheduledTitle: "Scheduled films",
    awaitingScheduledLead:
      "Films planned for a future date, sorted by scheduled date.",
    awaitingScheduledEmpty: "No scheduled films at the moment.",
    deliveryCountdownLabel: "Time remaining (24 h)",
    deliveryCountdownOverdue: "Deadline passed",
    deliveryCountdownHint: "Delivery within 24 h from film creation.",
    scheduledFor: "Scheduled for",
    scheduledForShort: "Scheduled: {date}",
    ...
    subscriptionSimulator: {
      title: "Simulate a client profile (my account)",
      lead:
        "Enable or remove a subscription on your admin account to browse the site as an Essential, Premium, or non-subscriber client.",
      ...
      successEssential: "Your account now simulates the Essential subscription.",
      successPremium: "Your account now simulates the Premium subscription.",
    },
    revokeTicketsTitle: "Revoke tickets",
    revokeTicketsLead:
      "Remove film tickets from a customer account. The balance cannot go below zero.",
    revokeTicketsEmailLabel: "Customer email",
    revokeTicketsCountLabel: "Number of tickets to remove",
    revokeTicketsSubmit: "Revoke tickets",
    revokeTicketsSubmitting: "Revoking…",
    grantJetonsTitle: "Grant tokens",
    grantJetonsLead: "Add sample tokens (30 s) to a customer account.",
    grantJetonsEmailLabel: "Customer email",
    grantJetonsCountLabel: "Number of tokens",
    grantJetonsSubmit: "Grant tokens",
    grantJetonsSubmitting: "Granting…",
    revokeJetonsTitle: "Revoke tokens",
    revokeJetonsLead:
      "Remove tokens from a customer account. The balance cannot go below zero.",
    revokeJetonsEmailLabel: "Customer email",
    revokeJetonsCountLabel: "Number of tokens to remove",
    revokeJetonsSubmit: "Revoke tokens",
    revokeJetonsSubmitting: "Revoking…",
    clientsListTitle: "Client accounts",
    clientsListLead:
      "All registered accounts with their characters, films, tickets and subscriptions.",
    clientsListCount: "{count} account(s)",
    clientsListEmpty: "No client accounts registered yet.",
    clientsRegisteredAt: "Registered on {date}",
    clientsUseEmail: "Use this email",
    clientsTickets: "Tickets",
    clientsJetons: "Tokens",
    clientsCharacters: "Characters",
    clientsFilms: "Films",
    clientsFilmsReady: "Delivered",
    clientsLocale: "Language",
    clientsSubscription: "Subscription",
    clientsNoSubscription: "None",
    clientsPurchased: "Purchase",
    clientsYes: "Yes",
    clientsNo: "No",
    clientsCharactersSection: "Characters ({count})",
    clientsFilmsSection: "Films ({count})",
    clientsNoCharacters: "No characters saved.",
    clientsNoFilms: "No films created.",
    clientsUntitledFilm: "Untitled",
    clientsSampleFilm: "Sample",
    sectionLoading: "Loading…",
    sectionLoadError: "Could not load this section. Please try again.",
    ...
    analyticsPageViews: "Arrivals",
    analyticsPageViewsHint: "One arrival per visitor per calendar day (midnight to midnight, Paris time)",
  ...
  notifications: {
    ...
    ticketBalanceRevokedTitle: "{count} ticket(s) removed from your account",
  ...
  space: {
    ...
    sampleFilmSynopsisPending:
      "Writing the summary for this 30-second sample…",
  ...
  tarifsPage: {
    ...
    features: {
      ...
      scheduleFilms: "Schedule your films",
  ...
  calendar: {
    backToSpace: "← Back to my account",
    eyebrow: "Planning",
    title: "Calendar",
    lead:
      "Pick one or more days to schedule your upcoming films. Tap a day to select it, then confirm.",
    subscriptionActive: "Active subscription — unlimited scheduling.",
    ticketsAvailable: "{count} ticket(s) available",
    slotsAvailable: "{count} slot(s) to schedule",
    noTicketsHint: "You need tickets to schedule a film.",
    buyTickets: "Buy tickets",
    selectHint:
      "Select one or more future days, then confirm. Already scheduled days are marked with a star.",
    rangeHint:
      "Scheduling available from {from}, until {to} (12 months from today).",
    ...
    legendScheduled: "Scheduled film",
    legendSelected: "Selected day",
    dayScheduled: "Film scheduled on {date}",
    daySelected: "Selected day: {date}",
    scheduledOn: "Film scheduled on {date}",
    createFilm: "Create film",
    cancelSchedule: "Cancel schedule",
    selectedOne: "1 day selected",
    selectedMany: "{count} days selected",
    scheduleOne: "Schedule this film",
    scheduleMany: "Schedule {count} films",
    scheduling: "Scheduling…",
    clearSelection: "Clear selection",
    successOne: "Your film has been scheduled.",
    successMany: "{count} films have been scheduled.",
    cancelSuccess: "Schedule cancelled.",
    errors: {
      notLoggedIn: "Log in to schedule a film.",
      noDatesSelected: "Select at least one day.",
      pastDate: "Cannot schedule a past date.",
      noTickets: "You have no tickets available.",
      alreadyScheduled: "A film is already scheduled on one of these dates.",
      notEnoughTickets: "Not enough tickets to schedule this many films.",
      notFound: "Schedule not found.",
      outOfRange:
        "This date is outside the allowed period (12 months from today).",
    },
  },
  legal: {
    backHome: "← Back to home",
  ...
  filmCreation: {
    ...
    form: {
      ...
      durationHint: "Slide to choose the duration, from 5 to 30 minutes.",
      durationSliderLabel: "Film duration",
      ...
      durationSampleQuestion: "Would you like to use your 30-second sample?",
      durationSampleYesHint: "1 token will be used for this sample.",
    ...
    errors: {
      ...
      scheduleNotAllowed:
        "Scheduling is not available for free trials or samples.",
      subscriptionGrantScheduleRequired:
        "With 0 tickets, schedule your 5-minute film for your next subscription credit date.",
      subscriptionGrantDurationOnly:
        "With no tickets available, only a 5-minute film is allowed via subscription.",
      subscriptionGrantDateTooEarly:
        "This date is too early. Pick a date from your next subscription credit onward.",
      subscriptionGrantQuotaReached:
        "You have reached the maximum number of no-ticket schedules for this subscription year.",
    },
    success:
    ...
    insufficientTicketsModal: {
      eyebrow: "Tickets",
      titleOne: "1 ticket is required for this duration.",
      titleMany: "{count} tickets are required for this duration.",
      titleFallback: "Tickets are required for this duration.",
      lead: "You don't have enough tickets to choose this duration.",
      missingOne: "1 ticket missing",
      missingMany: "{count} tickets missing",
      purchaseCta: "View pricing",
      decline: "Close",
      close: "Close",
    },
    scheduleFilm: {
      ...
      eyebrow: "Calendar",
      title: "Pick a date",
      lead: "Select the day you want to schedule this film for.",
      leadGrant:
        "With no tickets available, pick a date from when you receive your next subscription credit (5-minute film).",
      minDateHint: "First available date: {date}",
      quotaHint:
        "No-ticket schedules remaining this year: {remaining} of {total}.",
      quotaReached:
        "No-ticket scheduling quota reached for this subscription year.",
      preview: "Selected date: {date}",
      confirm: "Schedule your film",
      submitPending: "Scheduling…",
      cancel: "Cancel",
      close: "Close",
      selected: "Scheduled for {date}",
      change: "Change",
      clear: "Remove date",
    },
  },
  characters: {
    ...
    audioProcessing: "Analyzing audio…",

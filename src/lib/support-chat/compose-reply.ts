...
function intentBody(intent: SupportIntent, analysis: QuestionAnalysis): string {
  switch (intent) {
    ...
    case "pricing":
      return "Nos formules sont sur /creer : Essentiel Mois (29,99 €, 15 films/mois, 2–5 min), Essentiel Année (249,99 €/an), Premium Mois (54,99 €, 30 films/mois, 2–10 min) et Premium Année (399,99 €/an). Les offres annuelles indiquent l’économie par rapport au mensuel.";
    case "delivery":

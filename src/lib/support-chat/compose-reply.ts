...
function intentBody(intent: SupportIntent, analysis: QuestionAnalysis): string {
  switch (intent) {
    ...
    case "pricing":
      return "Nos formules sont sur /creer : Essentiel Mois (39,99 €, 15 films/mois, 2–5 min), Essentiel Année (349,99 €/an), Premium Mois (119,99 €, 30 films/mois, 2–10 min) et Premium Année (999,99 €/an). Les offres annuelles indiquent l’économie par rapport au mensuel.";
    case "delivery":

...
- Tarifs (/creer) :
  • Essentiel Mois : 39,99 €/mois — 15 films/mois, 2 à 5 min.
  • Essentiel Année : 349,99 €/an — même quota, économie vs mensuel.
...
export const SUPPORT_FAQ: FaqEntry[] = [
  {
    ...
    answer:
      "Nous proposons quatre formules sur la page Tarifs : Essentiel Mois (39,99 €, 15 films/mois de 2 à 5 min), Essentiel Année (349,99 €/an), Premium Mois (119,99 €, 30 films/mois de 2 à 10 min) et Premium Année (999,99 €/an). Les offres annuelles affichent l’économie par rapport au mensuel.",
  },
  {
    id: "delivery",
    keywords: [
